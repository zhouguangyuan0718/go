...
// ARM64 may merge feature-guarded CAS paths with a phi before returning.
// LLVM-DAG: define goabiinternal i1 @codegen.llvmAtomicCompareAndSwap32(
// LLVM-DAG: define goabiinternal i1 @codegen.llvmAtomicCompareAndSwap64(
// LLVM-DAG: extractvalue { i32, i1 } {{%[^,]+}}, 1
// LLVM-DAG: ret i1 {{%[^,]+}},
