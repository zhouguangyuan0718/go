...
// LLVM-NOT: runtime.writeBarrier
// LLVM-NOT: @llvm.go.gc.write.barrier
// LLVM: call void @goallc.gc.write.record(ptr %[[VALUE]], ptr %dst, i32 0)
...
// LLVM-OPT: call void @goallc.gc.write.record(ptr %[[OPT_VALUE]], ptr{{[^,]*}}, i32 0)
// LLVM-OPT-NOT: call void @goallc.gc.write.record
...
// LLVM: call void @goallc.gc.write.record(ptr null, ptr {{.*}}, i32 2)
// LLVM: store ptr null
// LLVM: store ptr null
// LLVM-LABEL: define goabiinternal void @codegen.llvmWriteBarrierMove(
// LLVM-SAME: #[[WBATTR]] gc "goallc" {{.*}}{
// LLVM: call void @goallc.gc.write.record(
// LLVM: store ptr
// LLVM: store ptr
