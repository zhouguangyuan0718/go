...
// The full uint64 count exceeds the lane width even though narrowing it
// first would produce zero. Folding the result must retain the CPU contract.
// LLVM-AMD64-LABEL: define {{.*}} @codegen.llvmSIMDShiftFoldedOversized(
// LLVM-AMD64-NOT: @llvm.sideeffect
// LLVM-AMD64: load i8, ptr {{.*}}!goallc.cpu.guard ![[AVX2:[0-9]+]]
// LLVM-AMD64-NOT: @llvm.sideeffect
// LLVM-AMD64: br i1 {{.*}}, label %[[OVERSIZED_ON:[a-zA-Z0-9_.]+]], label %{{[a-zA-Z0-9_.]+}}
// LLVM-AMD64: [[OVERSIZED_ON]]:
...
// LLVM-OPT-AMD64-LABEL: define internal {{.*}} @"codegen.llvmSIMDShiftFoldedOversized<goallc.fmv.avx2>"
// LLVM-OPT-AMD64-NOT: call void @llvm.sideeffect
// LLVM-OPT-AMD64-NOT: !goallc.cpu.require-anchor
// LLVM-OPT-AMD64-NOT: {{^[}]}}
...
// LLVM-ASM-AMD64: TEXT codegen.llvmSIMDShiftFoldedOversized(SB)
// LLVM-ASM-AMD64-NOT: llvm.sideeffect
// LLVM-ASM-AMD64-NOT: require-anchor
// LLVM-ASM-AMD64-NOT: VPS{{LL|RL|RA}}
// LLVM-NM-AMD64: D codegen.llvmSIMDShiftFoldedOversized.goallc.fmv.slot

//go:noinline
func llvmSIMDShiftFoldedOversized(x archsimd.Uint32x8) archsimd.Uint32x8 {
