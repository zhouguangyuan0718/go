...
entry:
  ...
  %statepoint = call goabiinternal token (i64, i32, ptr, i32, i32, ...) @llvm.experimental.gc.statepoint.p0(i64 1, i32 0, ptr elementtype(void ()) @callee, i32 0, i32 0, i32 0, i32 0) [ "deopt"(i64 1195461697, i64 16, i64 1, i64 1095520067, i64 12, i64 0, i64 0, i64 8, i64 8, i64 8, i64 1, i64 1, i64 64, i64 1, i64 1, i64 1095519299, i64 16), "gc-live"(ptr %slot) ]
  ret void
}
