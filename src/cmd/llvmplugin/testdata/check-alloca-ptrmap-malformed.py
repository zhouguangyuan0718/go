...
CASES = {
    "bad_kind": (
        ...
        "record tag is invalid",
    ),
    "truncated": (
        "i64 1195461697, i64 15, i64 1, i64 1095520067",
        "protocol is truncated",
    ),
    "bad_length": (
        "i64 1195461697, i64 14, i64 1, i64 1095520067, i64 11, "
        "ptr %slot, i64 0, i64 16, i64 8, i64 8, i64 2, i64 64, "
        "i64 1, i64 3, i64 1095519299, i64 15",
    ...
    "duplicate": (
        ...
        "i64 1095520067, i64 11, ptr %slot, i64 0, i64 16, i64 8, "
    ...
    "overlap": (
        "i64 1195461697, i64 26, i64 2, "
        "i64 1095520067, i64 11, ptr %slot, i64 0, i64 8, i64 8, "
    ...
    "padding": (
        "i64 1195461697, i64 15, i64 1, i64 1095520067, i64 11, "
