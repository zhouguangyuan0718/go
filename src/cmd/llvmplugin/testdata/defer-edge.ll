...
; The two local slots hold the defer-result contents and the ordinary %pointer
; GC spill. Rematerializing %result from its FrameIndex avoids a third,
; non-pointer spill slot for the frame address.
