...
func goALLCSIMDOpLiteral(encoded string) string {
	...
	lowering := goALLCSIMDConst("lowering", d.Lowering, map[string]string{
		...
		"round-scaled": "goALLCSIMDLowerRoundScaled", "floor-scaled": "goALLCSIMDLowerFloorScaled",
		"ceil-scaled": "goALLCSIMDLowerCeilScaled", "trunc-scaled": "goALLCSIMDLowerTruncScaled",
		"round-scaled-residue": "goALLCSIMDLowerRoundScaledResidue", "floor-scaled-residue": "goALLCSIMDLowerFloorScaledResidue",
		"ceil-scaled-residue": "goALLCSIMDLowerCeilScaledResidue", "trunc-scaled-residue": "goALLCSIMDLowerTruncScaledResidue",
		"bit-select": "goALLCSIMDLowerBitSelect", "bit-select-not": "goALLCSIMDLowerBitSelectNot",
		"blend-bytes": "goALLCSIMDLowerBlendBytes", "ternary": "goALLCSIMDLowerTernary",
		"blend-masked": "goALLCSIMDLowerBlendMasked",
		"compress":     "goALLCSIMDLowerCompress", "expand": "goALLCSIMDLowerExpand",
		"broadcast-low-masked": "goALLCSIMDLowerBroadcastLowMasked",
